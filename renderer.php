 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_logicgate_renderer extends qtype_ddtoimage_renderer_base {
    public function formulation_and_controls(question_attempt $qa,
        ...
        $img = html_writer::empty_tag('img', array(
                ...
                'alt' => get_string('dropbackground', 'qtype_logicgate')));
        ...
        $PAGE->requires->js_call_amd('qtype_logicgate/question', 'init',
    ...
    protected function hint(question_attempt $qa, question_hint $hint) {
        ...
        if ($hint->statewhichincorrect) {
            ...
            $output .= html_writer::nonempty_tag('div',
                    get_string('followingarewrong', 'qtype_logicgate', join(', ', $wrongparts)),
                    array('class' => 'wrongparts'));
        }
