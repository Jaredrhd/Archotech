 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_logicgate_question extends qtype_ddtoimage_question_base {
    ...
    public function check_file_access($qa, $options, $component, $filearea, $args, $forcedownload) {
        ...
        if ($component == 'qtype_logicgate' && $validfilearea) {
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleasedragatleastonemarker', 'qtype_logicgate');
    }
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_logicgate_drag_item {
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_logicgate_drop_zone {
    /** @var int Group of the item */
    public $group = 1;
    ...
    public function __construct($no, $shape, $coords) {
        $this->no = $no;
        $this->shape = qtype_logicgate_shape::create($shape, $coords);
        $this->coords = $coords;
    }
     ...
     */
    public function summarise() {
        return get_string('summariseplaceno', 'qtype_logicgate', $this->no);
    }
