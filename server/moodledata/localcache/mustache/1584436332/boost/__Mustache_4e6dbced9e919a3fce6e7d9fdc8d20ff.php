...
class __Mustache_4e6dbced9e919a3fce6e7d9fdc8d20ff extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template-inline')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block400b0017eae8e6ddc10abdca69f59269'),
            ));
...
';
    ...
    public function block400b0017eae8e6ddc10abdca69f59269($context)
    {
        $indent = $buffer = '';
