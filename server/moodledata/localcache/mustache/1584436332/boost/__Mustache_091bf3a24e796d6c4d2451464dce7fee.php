...
class __Mustache_091bf3a24e796d6c4d2451464dce7fee extends Mustache_Template
{
...
';
            ...
            $value = $context->findDot('element.staticlabel');
            $buffer .= $this->section58eaa542ac8c0d24385a2464d70dee30($context, $indent, $value);
        }
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section58eaa542ac8c0d24385a2464d70dee30(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
