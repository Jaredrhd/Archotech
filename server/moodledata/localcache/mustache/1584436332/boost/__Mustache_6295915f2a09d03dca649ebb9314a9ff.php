...
class __Mustache_6295915f2a09d03dca649ebb9314a9ff extends Mustache_Template
{
...
';
        $buffer .= $indent . '<div
';
        $buffer .= $indent . '    class="hidden bg-white position-relative border-bottom px-2 py-2"
';
