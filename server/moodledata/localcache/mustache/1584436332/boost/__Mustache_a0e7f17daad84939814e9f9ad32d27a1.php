...
class __Mustache_a0e7f17daad84939814e9f9ad32d27a1 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-group')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block72e3caf04fa10157ea518c8804a0432a'),
            ));
...
';
    ...
    public function block72e3caf04fa10157ea518c8804a0432a($context)
    {
        $indent = $buffer = '';
