...
class __Mustache_5b03229392db6ecfd36df831290d7cd5 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block88012986e2010a17922678baf4336781'),
            ));
...
';
    ...
    public function block88012986e2010a17922678baf4336781($context)
    {
        $indent = $buffer = '';
        // 'element.frozen' inverted section
        $value = $context->findDot('element.frozen');
