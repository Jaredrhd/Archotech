...
class __Mustache_110897c60e500bc99bba5aea1e45f3da extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '
';
        $buffer .= $indent . '<div class="hidden border-bottom px-2 py-3 view-search" ';
...
';
        $buffer .= $indent . '                    class="btn btn-outline-secondary"
';
