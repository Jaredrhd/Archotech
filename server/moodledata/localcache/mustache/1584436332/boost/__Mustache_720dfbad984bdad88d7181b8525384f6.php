...
class __Mustache_720dfbad984bdad88d7181b8525384f6 extends Mustache_Template
{
...
';
        ...
        // 'str' section
        $value = $context->find('str');
        $buffer .= $this->section2033193ff89364799ae6437b0e18447b($context, $indent, $value);
        $buffer .= '" class="btn btn-secondary btn-sm" href="#">
';
        $buffer .= $indent . '                        ';
        // 'pix' section
...
';
        $buffer .= $indent . '            <span class="fp-path-folder"><a class="fp-path-folder-name" href="#"></a></span>
';
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </div>
...
';
    ...
    private function section2033193ff89364799ae6437b0e18447b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = 'downloadfolder, repository';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= 'downloadfolder, repository';
                $context->pop();
            }
        }
