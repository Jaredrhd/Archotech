...
class __Mustache_9a7d2d20990b9519c66773d9e89ee811 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block5b0478a915e3ce9b5e238c63c505fa1a'),
            ));
...
';
    ...
    public function block5b0478a915e3ce9b5e238c63c505fa1a($context)
    {
        $indent = $buffer = '';
