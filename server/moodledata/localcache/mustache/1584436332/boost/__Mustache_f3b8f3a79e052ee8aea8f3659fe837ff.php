...
class __Mustache_f3b8f3a79e052ee8aea8f3659fe837ff extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template-inline')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block83a707440de39c024eb65cffa32c4ee1'),
            ));
...
';
    ...
    public function block83a707440de39c024eb65cffa32c4ee1($context)
    {
        $indent = $buffer = '';
