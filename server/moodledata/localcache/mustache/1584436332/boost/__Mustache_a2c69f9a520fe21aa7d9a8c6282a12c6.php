...
class __Mustache_a2c69f9a520fe21aa7d9a8c6282a12c6 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div id="menudayfilter" role="menu" class="dropdown-menu" data-show-active-item>
';
        $buffer .= $indent . '        <a
';
