...
require_once($CFG->dirroot . '/question/type/logicgate/edit_logicgate_form.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_logicgate_edit_form_test extends advanced_testcase {
    /**
     * Helper method.
     *
    ...
    protected function get_form() {
        ...
        $form = new qtype_logicgate_edit_form(new moodle_url('/'), $fakequestion, $category,
