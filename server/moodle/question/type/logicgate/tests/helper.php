...
class qtype_logicgate_test_helper extends question_test_helper {
     ...
     */
    public function make_logicgate_question_fox() {
        question_bank::load_question_definition_classes('logicgate');
        $dd = new qtype_logicgate_question();
        ...
        $dd->qtype = question_bank::get_qtype('logicgate');
        ...
        $dd->choices = $this->make_choice_structure(array(
                    new qtype_logicgate_drag_item('quick', 1, 0, 1),
                    new qtype_logicgate_drag_item('fox', 2, 0, 1),
                    new qtype_logicgate_drag_item('lazy', 3, 0, 1)

        ));

        $dd->places = $this->make_place_structure(array(
                            new qtype_logicgate_drop_zone(1, 'circle', '50,50;50'),
                            new qtype_logicgate_drop_zone(2, 'rectangle', '100,0;100,100'),
                            new qtype_logicgate_drop_zone(3, 'polygon', '0,100;200,100;200,200;0,200')
        ));
     ...
     * @return qtype_logicgate_question
     */
    public function make_logicgate_question_maths() {
        question_bank::load_question_definition_classes('logicgate');
        $dd = new qtype_logicgate_question();
        ...
        $dd->choices = $this->make_choice_structure(array(
                    new qtype_logicgate_drag_item('+', 1, 1, 0),
                    new qtype_logicgate_drag_item('-', 2, 1, 0),
                    new qtype_logicgate_drag_item('*', 3, 1, 0),
                    new qtype_logicgate_drag_item('/', 4, 1, 0)
        ...
        $dd->places = $this->make_place_structure(array(
                    new qtype_logicgate_drop_zone(1, 'circle', '50,50;50'),
                    new qtype_logicgate_drop_zone(2, 'rectangle', '100,0;100,100'),
                    new qtype_logicgate_drop_zone(3, 'polygon', '0,100;100,100;100,200;0,200')
        ));
    ...
    /**
     * @return stdClass date to create a logicgates question.
     */
    public function get_logicgate_question_form_data_mkmap() {
        global $CFG, $USER;
        ...
        $fs->create_file_from_pathname($filerecord, $CFG->dirroot .
                '/question/type/logicgate/tests/fixtures/mkmap.png');
     ...
     * @return stdClass date to create a logicgates question where one of the drag items has text '0'.
     */
    public function get_logicgate_question_form_data_zerodrag() {
        global $CFG, $USER;
        $fromform = new stdClass();
