...
define(['jquery', 'core/dragdrop', 'qtype_logicgate/shapes', 'core/key_codes'], function($, dragDrop, Shapes, keys) {
    ...
    function DragDropMarkersQuestion(containerId, bgImgUrl, readOnly, visibleDropZones) {
        ...
        if (readOnly) {
            this.getRoot().addClass('qtype_logicgate-readonly');
        }
    ...
    var questionManager = {
        ...
        setupEventHandlers: function() {
            $('body').on('mousedown touchstart',
                '.que.logicgate:not(.qtype_logicgate-readonly) div.dragitems .dragitem',
        ...
        getQuestionForEvent: function(e) {
            var containerId = $(e.currentTarget).closest('.que.logicgate').attr('id');
            return questionManager.questions[containerId];
        }
    };

    /**
     * @alias module:qtype_logicgate/question
     */
    return {
        /**
