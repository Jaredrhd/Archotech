...
/**
 * Language strings for qtype_logicgate.
...
$string['pluginname'] = 'Drag and drop logic gates';
$string['pluginname_help'] = 'Drag and drop logic gates require the respondent to drag logic gates and drop them onto the screen';
$string['pluginname_link'] = 'question/type/logicgate';
$string['pluginnameadding'] = 'Adding drag and drop logic gates';
$string['pluginnameediting'] = 'Editing drag and drop logic gates';
$string['pluginnamesummary'] = 'Logic gates are dragged and dropped onto a background image.';
